...
% include dim 6 MSD matrices from morandin/gugercin source
% in experiment use dim 100 as FOM and reduce to lower orders as needed
% quadratic models are prob only feasible upto 10/12, beyond that we overfit
...
% try to run SOBMOR on the inferred LROM :)
