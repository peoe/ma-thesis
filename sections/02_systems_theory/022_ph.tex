...
These following remarks closely follow~\cite[Definition~4.9]{Mehrmann2023}.
...
\begin{definition}[{Adapted from~\cite[Definition~4.9]{Mehrmann2023}}]\label{def:phlti}
...
\begin{remark}[{Adapted from~\cite[Section~4.3]{Mehrmann2023}}]
