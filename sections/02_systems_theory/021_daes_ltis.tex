...
\begin{definition}[Adapted from~\cite{CGH2022}]\label{def:minimal-system}
...
\begin{definition}[{Adapted from~\cite[Section~2]{Benner2017}}]
...
\begin{definition}[{Adapted from~\cite[Section~2]{Benner2017}}]\label{def:lti-stability}
