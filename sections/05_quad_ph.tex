...
Moreover, it is also possible to consider quadratic controls and by extension quadratic output terms.
...
\begin{equation*}
    ...
    \end{gathered}
\end{equation*}
\itodo{update the combined matrices! currently we simulate with single $E, J, R$!}
...
Lastly, choosing this method also resolves the issue of constructing an appropriate matrix $E_\msc{q}$ because we no longer need to couple quadratic internal states.
