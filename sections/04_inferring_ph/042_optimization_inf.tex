...
In order to derive a solution algorithm for the \ac{PHDMD} problem~\eqref{eq:ph-dmd-minimization-problem} we have to take two steps into consideration:
...
\begin{lemma}[{Adapted from~\cite[Theorem~3.11]{Morandin2023}}]
...
\begin{theorem}[{Adapted from~\cite[Theorem~3.3]{SV2023},~\cite[Lemma~4]{Schwerdtner2021} and~\cite[Theorem~1]{Schwerdtner2023}}]
